<x-admin-layout>
    <div class="pitstop-container py-8 sm:py-10">
        <x-ui.page-header title="Detail Layanan" description="Lihat detail informasi layanan bengkel.">
            <x-slot name="actions">
        ...
        <x-ui.card class="mt-6">
            ...
            <div class="mt-5 flex items-start justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 leading-7 text-slate-500">
                        {{ $service->description ?: 'Belum ada deskripsi layanan.' }}</p>
                </div>
            ...
            <dl class="mt-6 grid gap-3 sm:grid-cols-2">
                <div class="rounded-xl bg-slate-50 p-4">
                    ...
                    <dd class="mt-1 font-semibold text-slate-700">Rp {{ number_format($service->price, 0, ',', '.') }}
                    </dd>
                </div>
                <div class="rounded-xl bg-slate-50 p-4">
