<x-public-layout>
    <section class="bg-white">
        <div class="pitstop-container py-12 text-center sm:py-16">
            <span class="inline-flex rounded-full bg-blue-100 px-3 py-1 text-xs font-semibold text-blue-700">Layanan
                PitStop</span>
            <h1 class="mt-4 text-3xl font-bold tracking-tight text-blue-900 sm:text-4xl">Pilih Layanan</h1>
            <p class="mx-auto mt-3 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
                Pilih layanan sesuai kebutuhan kendaraanmu.
            </p>
        </div>
    </section>

    <section class="bg-slate-50 py-12 sm:py-16" x-data="publicServiceCatalog({
        ...
        <div class="pitstop-container">
            <x-ui.card>
                <label>
                    ...
                    <input type="search" x-model="search" @input.debounce.350ms="fetchServices"
            ...
            <div x-show="loading" x-cloak
                class="mt-5 rounded-2xl border border-slate-200 bg-white px-6 py-10 text-center shadow-sm">
            ...
            <div class="mt-10 rounded-2xl bg-blue-900 px-5 py-7 text-center text-white sm:px-8">
                ...
                <p class="mt-2 text-sm text-blue-200">Masuk untuk memilih jadwal dan membuat booking service
                    kendaraanmu.</p>
                <x-ui.button href="{{ route('login', ['redirect' => '/dashboard']) }}" class="mt-5">Booking
                ...
                <div>
                    ...
                    <template x-if="! detail.image_url">
                        <div class="flex h-52 items-center justify-center rounded-xl bg-blue-50 sm:h-64">
                            <span
                                class="flex size-16 items-center justify-center rounded-2xl bg-blue-600 text-lg font-bold text-white">PS</span>
                        </div>
                    </template>
                    ...
                    <dl class="mt-5 grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div class="rounded-xl bg-slate-50 p-3">
                            ...
                            <dd class="mt-1 font-semibold text-slate-700" x-text="`${detail.duration_minutes} menit`">
                            </dd>
                        </div>
                    </dl>
                    <x-ui.button href="{{ route('login', ['redirect' => '/dashboard']) }}" class="mt-5 w-full">Booking
                        Layanan Ini</x-ui.button>
                </div>
            </template>
        </x-ui.modal>
    </section>
